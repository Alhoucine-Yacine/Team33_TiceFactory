...
public class TeacherFormatChecker implements ExcelFormat  {
    ...
    @Override
    public boolean checkDoublants(String f1, int tab[]) throws IOException, DuplicatedException { // vérifie s'il ya un doublon et
        // mettre ses cordonnées dans tab
    ...
    public static void copyRow(Row r1,Row r2)  {// copies la ligne row1 dans  row2
